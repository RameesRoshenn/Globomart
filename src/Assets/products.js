...
export const serviceData = [
  {
    icon: <i class="fa-solid fa-truck-fast"  style={{ fontSize: '2rem', marginBottom: '1rem' }}></i>,
    title: "Free Shipping",
    subtitle: "Lorem ipsum dolor sit amet.",
    bg: "#fdefe6",
  },
  {
    icon: <i class="fa-solid fa-credit-card" style={{ fontSize: '2rem', marginBottom: '1rem' }}></i>,
    title: "Safe Payment",
    subtitle: "Lorem ipsum dolor sit amet.",
    bg: "#ceebe9",
  },
  {
    icon: <i class="fa-solid fa-shield-halved" style={{ fontSize: '2rem', marginBottom: '1rem' }}></i>,
    title: "Secure Payment",
    subtitle: "Lorem ipsum dolor sit amet.",
    bg: "#e2f2b2",
  },
  {
    icon:  <i className="fa-solid fa-award" style={{ fontSize: '2rem', marginBottom: '1rem' }}></i>,
